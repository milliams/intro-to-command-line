...
From this point forward, you will need to [download the course materials](https://github.com/milliams/intro-to-command-line/raw/main/command-line-files.zip); move this to a suitable folder, and unzip it.
- If you are using GitBash on Windows, copy and run this command
```
git clone https://github.com/milliams/intro-to-command-line.git
```
{{< /admonition >}}
...
```
alexandre-dumas   example_files     sandpit    some_plays
```
